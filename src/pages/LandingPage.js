...
export default function LandingPage() {
  return (
    <div className="">      
      ...
      <img className="fixed left-0 bottom-0 z-0" src={Circle} alt="Burst" />
      ...
      <div className="ml-40 flex items-center justify-center">
        <div className="">
          ...
          <p className="font-bold text-xl mb-6">Get rewards by participating in survey</p>
          <div className="w-full flex items-center justify-center">
            <Link className="text-red-300 border-2 border-black rounded-md px-4 py-2 font-bold text-xl">Get Started</Link>
          </div>
        </div>
        <div className=" z-50">
